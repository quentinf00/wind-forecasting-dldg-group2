...
trainer = pl.Trainer(gpus=[0], max_epochs=400, callbacks=[model_checkpoint], log_every_n_steps=2)
"""
version_6
"""
...
ckpt_path = 'lightning_logs/version_6/checkpoints/epoch=97-step=6173.ckpt'
ckpt_path = 'lightning_logs/version_12/checkpoints/epoch=125-step=7069.ckpt'
ckpt_path = 'lightning_logs/version_15/checkpoints/epoch=161-step=2591.ckpt'
# ckpt_path=None
# trainer.fit(lit_mod, train_dl,val_dataloaders=val_dl, ckpt_path=ckpt_path)

trainer = pl.Trainer(gpus=[0], max_epochs=400, callbacks=[model_checkpoint])
trainer.test(lit_mod, test_dataloaders=test_dl, ckpt_path=ckpt_path)
